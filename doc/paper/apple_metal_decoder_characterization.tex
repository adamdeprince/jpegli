...
identical to CPU JPEGli.  Across a separate 1,500-window campaign, it consumes
...
high-quality 4:4:4.  GPU offload introduces no new quality tradeoff because
the output pixels are identical to CPU JPEGli.
...
warm baseline 4:2:0 latency, preserves exact pixels, and reduces
